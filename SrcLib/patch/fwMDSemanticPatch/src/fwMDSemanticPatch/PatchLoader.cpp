...
void PatchLoader::loadPatches()
{
    ...
    versionManager->buildVersionTable("./share/fwMDSemanticPatch_" fwMDSemanticPatch_VERSION "/");
    versionManager->buildLinkTable("./share/fwMDSemanticPatch_" fwMDSemanticPatch_VERSION "/");
}
