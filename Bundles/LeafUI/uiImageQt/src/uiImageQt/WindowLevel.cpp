...
void WindowLevel::starting() throw(::fwTools::Failed)
{
    ...
    QIcon ico;
    QString squareIcon(BUNDLE_PREFIX "/uiImageQt_" uiImageQt_VERSION "/square.png");
    QString rampIcon(BUNDLE_PREFIX "/uiImageQt_" uiImageQt_VERSION "/ramp.png");
    ...
    QIcon icon;
    QString windo(BUNDLE_PREFIX "/uiImageQt_" uiImageQt_VERSION "/windowing.svg");
    icon.addFile(windo, QSize(), QIcon::Normal,QIcon::On);
    QString nowindo(BUNDLE_PREFIX "/uiImageQt_" uiImageQt_VERSION "/nowindowing.svg");
